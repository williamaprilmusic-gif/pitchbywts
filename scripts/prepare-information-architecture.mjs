...
const groupedMarker='PITCHLINE_INFORMATION_ARCHITECTURE_APPLIED';
...
if(!source.includes("const [openNavGroups,setOpenNavGroups]")){
 source=source.replace(stateMarker,`${stateMarker}const [openNavGroups,setOpenNavGroups]=useState<string[]>(['football','team','club','operations']);`);
}
