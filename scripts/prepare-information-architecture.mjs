...
if(source.includes("const roleNavGroups:RoleNavGroup[]=")&&source.includes("className='workspace-nav")){
...
source=`/* WTS_WORKSPACE_CONSOLIDATION_APPLIED */\n/* ${marker} */\n${source}`;
fs.writeFileSync(path,source);
console.log('Six role-based workspace groups applied.');
